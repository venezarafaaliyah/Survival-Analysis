...
model2 <- coxph(y ~ leu$Sex+ leu$logWBC)
summary(model2)
...
#ln(-lnS)
plot(kmfit_leu, fun = "cloglog", xlab ="Time", ylab = "log-log S", lty = c("solid", "dashed"))
legend("topright", c("Placebo", "6-MP treatment"), lty = c("solid", "dashed"))
...
names(kmfit_leu2)
plot(kmfit_leu2, fun = "cloglog", xlab ="Time", ylab = "log-log S", col = c("black", "red", "blue"))
...
##Sex
kmfit_leu3 <- survfit(y ~ leu$Sex)
#names(kmfit_leu3)
# log-log S
plot(kmfit_leu3, fun = "cloglog", xlab ="Time", ylab = "log-log S",lty=c("solid", "dashed"))
legend("topleft", c("Females", "Males"), lty=c("solid", "dashed"))
# -log-log S
plot(kmfit_leu3, fun = minusloglog, xlab ="Time", ylab = "-log-log S", lty=c("solid", "dashed"))
legend("topright", c("Females", "Males"), lty=c("solid", "dashed"))
...
#plot(coxph(y ~ Treatment, data = leu), lty = c("solid", "dashed"), xlab = "Time", ylab = "Survival Probabilities")
#legend("topright", c("Placebo", "6-MP"), lty = c("solid", "dashed"))
